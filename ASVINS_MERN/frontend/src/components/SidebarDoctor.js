    ...
    return (
        <div>
            ...
            <ul className="sidebar-items">
                {/* <li><Link to="/dashboard">Health</Link></li> */}
                <li><Link to="/doctor-dashboard/appointments">Appointments</Link></li>
                <li><Link to="/doctor-dashboard/chat">Chat</Link></li>
                {/* <li><Link to="/dashboard/doctors">Doctors</Link></li>
                <li><Link to="/dashboard/insurance">Insurance</Link></li> */}
